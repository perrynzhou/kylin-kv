...
running(leaking) after all tests.
	...
	import "go.etcd.io/etcd/client/utils/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "go.etcd.io/etcd/client/utils/testutil.interestingGoroutines") ||
			strings.Contains(stack, "go.etcd.io/etcd/client/utils/logutil.(*MergeLogger).outputLoop") ||
